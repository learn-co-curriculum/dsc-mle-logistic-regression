...
<img src="https://render.githubusercontent.com/render/math?math= L(\beta_0,\beta_1)=\prod^N \pi_i^{y_i}(1-\pi_i)^{n_i-y_i}=\prod^N \dfrac{\text{exp}\{y_i(\beta_0 %2B \beta_1 x_i)\}}{1 %2B \text{exp}(\beta_0 %2B \beta\_1 x\_i)}">  
